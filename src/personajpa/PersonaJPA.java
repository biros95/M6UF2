...
public class PersonaJPA {
    ...
    public static void main(String[] args) {
        try {
            ...
            Polissa poliEliminar = pc.BuscarPerVehicle(vehiPerEliminar.getId()); //Busquem la polissa a la qual esta vinculat el vehicle
            ...
            System.out.println("Si busquem ara no existeix: " + vc.Buscar(vehiPerEliminar.getId()));
            System.out.println(pc.BuscarPerVehicle(vc.Buscar(2141L).getId()));//Realitzem una cerca de polissas que te el vehicle
